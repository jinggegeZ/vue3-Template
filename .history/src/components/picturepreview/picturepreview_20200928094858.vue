  ...
  <div v-for="(item, index) in piclist" :key="index">
    ...
    <div class="d-f j-c a-l box" v-if="flags === true">
      <div class="dialogbox" @click="closedialog"></div>
        ...
        <div class="inforbox">
          <div> <img class="ximg" src="../../images/lager.png" alt="" /></div>
           <div> <img class="ximg" src="../../images/small.png" alt="" /></div>
           <div> <img class="ximg" src="../../images/shun.png" alt="" /></div>
           <div> <img class="ximg" src="../../images/ni.png" alt="" /></div>
