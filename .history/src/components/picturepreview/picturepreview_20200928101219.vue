    ...
    <div class="d-f j-c a-l box" v-if="flags === true">
      <div class="dialogbox" @click="closedialog"></div>
        <div class="imgpostztion">
          <div class="leftimg"><img class="inforimg" src="../../images/left.png" alt=""></div>
          <div class="d-f j-c a-l">
          <img class="imgs" :style="{ transform: 'scale(' + addscale + ') rotate(' + angle + 'deg)'}" :src="item" alt="" />
          </div>
          <div class="rightimg"><img class="inforimg" src="../../images/right.png" alt=""></div>
        <div class="inforbox">
          <div> <img class="inforimg" src="../../images/lager.png" alt="" @click="addScale" /></div>
           ...
           <div> <img class="inforimg" src="../../images/shun.png" alt="" @click="addAngle" /></div>
           <div> <img class="inforimg" src="../../images/ni.png" alt="" @click="reduceAngle" /></div>
        </div>
        </div>
