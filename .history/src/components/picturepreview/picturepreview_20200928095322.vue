    ...
    <div class="d-f j-c a-l box" v-if="flags === true">
      <div class="dialogbox" @click="closedialog"></div>
        <div class="imgpostztion">
          ...
          <img style="width:250px;height:250px" :style="{transfrom}" :src="item" alt="" />
          </div>
        <div class="inforbox">
          <div> <img class="inforimg" src="../../images/lager.png" alt="" /></div>
           <div> <img class="inforimg" src="../../images/small.png" alt="" /></div>
